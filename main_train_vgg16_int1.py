...
def main():
    ...
    #state_dict =t.load('/home/likai/mix_vgg/vgg_quant_test/lsq_sparse/out/VGG16_ImageNet_bmix_s0_20230526-180905/VGG16_ImageNet_bmix_s0_best.pth.tar')['state_dict']
    ...
    params = [{'params': base_params},
          ...
          {'params': model.module.features[ 7].parameters(), 'lr': args.optimizer.learning_rate * 1},#2
          {'params': model.module.features[10].parameters(), 'lr': args.optimizer.learning_rate * 1},#4
          {'params': model.module.features[12].parameters(), 'lr': args.optimizer.learning_rate * 1},#2
          ...
          {'params': model.module.features[19].parameters(), 'lr': args.optimizer.learning_rate * 1},#1
          ...
          {'params': model.module.features[26].parameters(), 'lr': args.optimizer.learning_rate * 1},#2
