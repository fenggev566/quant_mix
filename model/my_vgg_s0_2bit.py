...
kbs_cfgs: Dict[str, List[Union[str, int]]] = {
    ...
    'D': [[ 64,8,8,0.00,16,1], [ 64,6,6,0.00,16,1], 'M', #ã€Cin, Weight_bit_width, Activation_bit_width, sparsity, Tin, Groupã€?    
...
#     'A': [64, 'M', 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
#     'B': [64, 64, 'M', 128, 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
#     'D': [[ 64,8,8,0.00,16,1], [ 64,4,4,0.00,16,1], 'M', #ã€Cin, Weight_bit_width, Activation_bit_width, sparsity, Tin, Groupã€?#           [128,4,4,0.00,16,1], [128,2,2,0.00,16,1], 'M', 
