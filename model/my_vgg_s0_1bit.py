...
kbs_cfgs: Dict[str, List[Union[str, int]]] = {
    ...
    'D': [[ 64,8,8,0.00,16,1], [ 64,6,6,0.00,16,1], 'M',     
...
#     'B': [64, 64, 'M', 128, 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
#     'D': [[ 64,8,8,0.00,16,1], [ 64,6,6,0.00,16,1], 'M',     
#           [128,3,3,0.00,16,1], [128,3,3,0.00,16,1], 'M', 
#           [256,3,3,0.00,16,1], [256,3,3,0.00,16,1], [256,3,3,0.00,16,1], 'M', 
#           [512,3,3,0.00,16,1], [512,3,3,0.00,16,1], [512,3,3,0.00,16,1], 'M', 
#           [512,3,3,0.00,16,1], [512,3,3,0.00,16,1], [512,3,3,0.00,16,1], 'M'],
#     'E': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512, 'M'],
# }
...
#     'A': [64, 'M', 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
#     'B': [64, 64, 'M', 128, 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
#     'D': [[ 64,8,8,0.00,16,1], [ 64,4,4,0.00,16,1], 'M', #【Cin, Weight_bit_width, Activation_bit_width, sparsity, Tin, Group�?#       
#     [128,4,4,0.00,16,1], [128,2,2,0.00,16,1], 'M', 
#           [256,2,2,0.00,16,1], [256,4,4,0.00,16,1], [256,4,4,0.00,16,1], 'M', 
#           [512,4,4,0.00,16,1], [512,2,2,0.00,16,1], [512,4,4,0.00,16,1], 'M', 
#           [512,4,4,0.00,16,1], [512,4,4,0.00,16,1], [512,4,4,0.00,16,1], 'M'],
#     'E': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512, 'M'],
# }
...
def vgg16(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> VGG:
    ...
    """
    return _vgg16('vgg16', 'D', False, pretrained, progress, **kwargs)
